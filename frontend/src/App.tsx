        ...
        >
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Direct fetch failed. This usually happens when your{" "}
                <span className="text-foreground font-bold">
                  country is blocked
                </span>{" "}
                by Spotify or your IP is restricted. Would you like to enable
                the{" "}
                <span className="text-foreground font-bold">SpotFetch API</span>{" "}
                to bypass this?
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
