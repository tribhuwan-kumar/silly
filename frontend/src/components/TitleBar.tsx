...
export function TitleBar() {
  ...
  useEffect(() => {
    ...
    const handleSettingsUpdate = (event: any) => {
      ...
      if (
        updatedSettings &&
        typeof updatedSettings.useSpotFetchAPI !== "undefined"
      ) {
  ...
  return (
    <>
      ...
      <div className="fixed top-1.5 right-2 z-50 flex h-7 gap-0.5 items-center">
        <Menubar
          className="border-none bg-transparent shadow-none px-0 mr-1"
        ...
        >
          <MenubarMenu>
            ...
            <MenubarContent align="end" className="min-w-[200px]">
                ...
                <TooltipProvider delayDuration={300}>
                  <Tooltip>
                    ...
                    <TooltipContent side="left" className="max-w-xs">
                      ...
                      <p className="text-xs">
                        Afghanistan, Antarctica, Central African Republic,
                        China, Cuba, Eritrea, Iran, Myanmar, North Korea,
              ...
              <MenubarSeparator />
              <MenubarItem
                onClick={handleSpotFetchAPIToggle}
