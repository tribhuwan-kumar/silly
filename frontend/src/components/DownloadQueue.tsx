      ...
      <DialogContent className="max-w-[1200px] w-[95vw] max-h-[80vh] flex flex-col p-0 gap-0 [&>button]:hidden">
        <DialogHeader className="px-6 pt-6 pb-4 border-b space-y-0">
          ...
          <div className="flex items-center gap-4 text-sm">
            <div
              className={`flex items-center gap-1.5 cursor-pointer hover:opacity-80 transition-all select-none ${filterStatus === "queued" ? "bg-secondary px-2 py-0.5 rounded-md ring-1 ring-border" : ""}`}
            ...
            <div
              className={`flex items-center gap-1.5 cursor-pointer hover:opacity-80 transition-all select-none ${filterStatus === "completed" ? "bg-green-500/10 px-2 py-0.5 rounded-md ring-1 ring-green-500/20" : ""}`}
            ...
            <div
              className={`flex items-center gap-1.5 cursor-pointer hover:opacity-80 transition-all select-none ${filterStatus === "skipped" ? "bg-yellow-500/10 px-2 py-0.5 rounded-md ring-1 ring-yellow-500/20" : ""}`}
            ...
            <div
              className={`flex items-center gap-1.5 cursor-pointer hover:opacity-80 transition-all select-none ${filterStatus === "failed" ? "bg-red-500/10 px-2 py-0.5 rounded-md ring-1 ring-red-500/20" : ""}`}
